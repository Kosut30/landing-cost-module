...
const Analytics = () => {
    ...
    const fetchAnalyticsData = async () => {
        try {
            ...
            const supplierComparisonResponse = await axios.get('http://172.20.10.2:5000/api/supplier-comparison');
            ...
            const productCategoryResponse = await axios.get('http://172.20.10.2:5000/api/product-category-analysis');
