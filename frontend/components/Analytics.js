...
const Analytics = () => {
    ...
    const fetchAnalyticsData = async () => {
        try {
            ...
            const landingCostsResponse = await axios.get('http://192.168.83.155:5000/api/imports/landing-cost-trend');
            ...
            const supplierComparisonResponse = await axios.get('http://192.168.83.155:5000/api/supplier-comparison');
            ...
            const productCategoryResponse = await axios.get('http://192.168.83.155:5000/api/product-category-analysis');
