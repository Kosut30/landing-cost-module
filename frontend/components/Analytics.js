...
const Analytics = () => {
    ...
    const fetchAnalyticsData = async () => {
        try {
            ...
            const landingCostsResponse = await axios.get('http://172.20.10.2:5050/api/imports/landing-cost-trend');
            ...
            const supplierComparisonResponse = await axios.get('http://172.20.10.2:5050/api/supplier-comparison');
            ...
            const productCategoryResponse = await axios.get('http://172.20.10.2:5050/api/product-category-analysis');
